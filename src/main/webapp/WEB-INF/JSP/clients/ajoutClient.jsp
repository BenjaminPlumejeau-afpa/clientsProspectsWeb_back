          ...
          <section class="card">
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="inputRaisonSociale" name="raisonSociale" required>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="inputCA" name="chiffreAffaires" required>
              </div>

              <div class="mb-3">
                <label for="inputNbEmployes" class="form-label">Nombre d'employés</label>
                <input type="number" class="form-control" id="inputNbEmployes" name="nbEmployes" required>
              </div>
          ...
          <section class="card">
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="inputNumRue" name="numRue" required>
              </div>

              <div class="mb-3">
                <label for="inputNomRue" class="form-label">Rue</label>
                <input type="text" class="form-control" id="inputNomRue" name="nomRue" required>
              </div>

              <div class="mb-3">
                <label for="inputCP" class="form-label">Code Postal</label>
                <input type="text" class="form-control" pattern="[0-9]{5}" id="inputCP" name="codePostal" required>
              </div>
            ...
            <section class="card">
              <div class="card-body">
                ...
                <div class="m-4">
                          ...
                          id="areaComment" name="commentaire"></textarea>
                </div>
