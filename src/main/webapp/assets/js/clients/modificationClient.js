...
function controleFormulaire(event) {
    ...
    // NaN rend toute comparaison false ; Number(...) renvoie NaN si pas possible de parse un nombre
    if (Number(inputChiffreAffaires.value.trim()) <= 200) {
    ...
    if (Number(inputNbEmployes.value.trim()) <= 0) {
